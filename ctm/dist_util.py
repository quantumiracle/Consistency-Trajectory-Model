...
# https://github.com/sony/ctm/blob/36c0f57d6cc0cff328f54852e0487e9e4e78f7ce/commands/CTM%2BDSM_command.sh#L4
...
def setup_dist_without_MPI(device_id):
    ...
    world_size = os.environ["WORLD_SIZE"] = OMPI_COMM_WORLD_SIZE
    rank = os.environ['RANK'] = OMPI_COMM_WORLD_RANK
    local_rank = os.environ['LOCAL_RANK'] = OMPI_COMM_WORLD_LOCAL_RANK
